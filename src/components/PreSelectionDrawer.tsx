  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("/api/submit", {
        ...
        body: JSON.stringify({
          form_type: "quote",
          subject: `Material Selection Request — ${formData.name} — Italgres`,
      ...
      setSubmitResult({
        message: "Your selection has been sent to us.",
      ...
      alert(err.message || "An error occurred while compiling your selection.");
    } finally {
                ...
                {submitResult ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <form onSubmit={handleSubmit} className="border-t border-neutral-200 pt-6 space-y-4">
                      ...
                      <p className="text-[11px] text-neutral-500 font-light leading-relaxed">
                        We will review inventory and contact you for available options.
                      </p>
